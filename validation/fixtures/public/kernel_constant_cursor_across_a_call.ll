...
define void @kernel_constant_cursor_across_a_call(ptr addrspace(1) captures(none) "air-buffer-no-alias" %0, i32 %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds <4 x float>, ptr addrspace(1) %0, i64 0, i64 1
  %4 = bitcast ptr addrspace(1) %3 to ptr addrspace(1)
  %5 = load i8, ptr addrspace(1) %4, align 1, !tbaa !21, !alias.scope !24
  %6 = zext i8 %5 to i32
  %7 = getelementptr inbounds <4 x float>, ptr addrspace(1) %0, i64 2
  %8 = add i32 %6, %1
  tail call fastcc void @_ZL8store_atPU9MTLdeviceDv4_fj(ptr addrspace(1) %7, i32 %8) #3, !alias.scope !24
  %9 = tail call fast float @air.convert.f.f32.u.i32(i32 %6) #4
  %10 = insertelement <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, float %9, i64 0
  store <4 x float> %10, ptr addrspace(1) %0, align 16, !tbaa !21, !alias.scope !24
  ret void
}
...
!9 = !{ptr @kernel_constant_cursor_across_a_call, !10, !11}
!10 = !{}
!11 = !{!12, !13}
...
!20 = !{!"/private/tmp/curs/f.metal"}
!21 = !{!22, !22, i64 0}
!22 = !{!"omnipotent char", !23, i64 0}
!23 = !{!"Simple C++ TBAA"}
!24 = !{!25}
!25 = distinct !{!25, !26, !"air-alias-scope-arg(0)"}
!26 = distinct !{!26, !"air-alias-scopes(kernel_constant_cursor_across_a_call)"}
