; Owned synthetic fixture for authored irreducible-control-flow execution over three blocks.
...
; structured control flow cannot spell it. `reloop_nest` declines (`irreducible control flow`, 9
; blocks) and the state-machine construction in src/native/relooper.rs takes it.
;
; %exit's `%pf` is a POINTER phi with three incomings, each a different constant offset into the
; thread's four-word window. A logical pointer cannot be spilled to a variable, so the relooper has
; to rebuild it -- and WHERE the value lands reads the arm it rebuilt back out of the buffer.
;
; The sibling .metal is the same automaton with one entry -- state in {0,1,2}, step
; `v = v*3 | v+7 | v^255`, `i += 1`, exit at `i >= n` writing v to `window[state]`, else advance the
; state cyclically -- and Metal runs THAT. The two spellings differ only in control-flow shape.
source_filename = "validation/fixtures/public/kernel_irreducible_three_way.metal"
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v28-apple-macosx26.0.0"

define void @irreducible_three_way(ptr addrspace(1) %output, ptr addrspace(1) %input, i32 %tid) {
entry:
  ...
  %win = shl i32 %tid, 2
  %win64 = zext i32 %win to i64
  %base = getelementptr inbounds i32, ptr addrspace(1) %output, i64 %win64
  %sel = urem i32 %n, 3
...
a:
  ...
  %p_a = getelementptr inbounds i32, ptr addrspace(1) %base, i64 0
...
b:
  ...
  %p_b = getelementptr inbounds i32, ptr addrspace(1) %base, i64 1
...
c:
  ...
  %p_c = getelementptr inbounds i32, ptr addrspace(1) %base, i64 2
...
!air.kernel = !{!0}
!0 = !{ptr @irreducible_three_way, !1, !2}
!1 = !{}
!2 = !{!3, !4, !5}
