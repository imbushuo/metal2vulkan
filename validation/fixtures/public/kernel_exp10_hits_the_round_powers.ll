...
; is wanted here: it emits `air.fast_exp10.f32` and `air.fast_log10.f32`, which are the only two
; spellings of these the corpus contains.
; Not derived from a third-party metallib.
; ModuleID = 'kernel_exp10_hits_the_round_powers.bc'
source_filename = "validation/fixtures/public/kernel_exp10_hits_the_round_powers.metal"
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v28-apple-macosx26.0.0"

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite)
define void @kernel_exp10_hits_the_round_powers(ptr addrspace(1) noundef readonly captures(none) "air-buffer-no-alias" %0, ptr addrspace(1) noundef writeonly captures(none) "air-buffer-no-alias" %1) local_unnamed_addr #0 {
  ...
  %18 = tail call fast float @air.fast_exp10.f32(float %3) #2
  store float %18, ptr addrspace(1) %1, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %19 = tail call fast float @air.fast_exp10.f32(float %5) #2
  %20 = getelementptr inbounds float, ptr addrspace(1) %1, i64 1
  store float %19, ptr addrspace(1) %20, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %21 = tail call fast float @air.fast_exp10.f32(float %7) #2
  %22 = getelementptr inbounds float, ptr addrspace(1) %1, i64 2
  store float %21, ptr addrspace(1) %22, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %23 = tail call fast float @air.fast_exp10.f32(float %9) #2
  %24 = getelementptr inbounds float, ptr addrspace(1) %1, i64 3
  store float %23, ptr addrspace(1) %24, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %25 = tail call fast float @air.fast_exp10.f32(float %11) #2
  %26 = getelementptr inbounds float, ptr addrspace(1) %1, i64 4
  store float %25, ptr addrspace(1) %26, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %27 = tail call fast float @air.fast_log10.f32(float %13) #2
  %28 = getelementptr inbounds float, ptr addrspace(1) %1, i64 5
  store float %27, ptr addrspace(1) %28, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %29 = tail call fast float @air.fast_log10.f32(float %15) #2
  ...
  %31 = tail call fast float @air.fast_log10.f32(float %7) #2
  %32 = getelementptr inbounds float, ptr addrspace(1) %1, i64 7
  store float %31, ptr addrspace(1) %32, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %33 = tail call fast float @air.fast_log10.f32(float %17) #2
  %34 = bitcast float %33 to i32
  %35 = and i32 %34, 2147483647
  %36 = icmp ugt i32 %35, 2139095040
  %37 = select fast i1 %36, float 1.000000e+00, float 0.000000e+00
  %38 = getelementptr inbounds float, ptr addrspace(1) %1, i64 8
  store float %37, ptr addrspace(1) %38, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  ret void
}

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none)
declare float @air.fast_exp10.f32(float) local_unnamed_addr #1

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none)
declare float @air.fast_log10.f32(float) local_unnamed_addr #1
...
!9 = !{ptr @kernel_exp10_hits_the_round_powers, !10, !11}
!10 = !{}
!11 = !{!12, !13}
...
!20 = !{!"/private/tmp/e10/kernel_exp10_hits_the_round_powers.metal"}
!21 = !{!22, !22, i64 0}
!22 = !{!"float", !23, i64 0}
...
!27 = distinct !{!27, !"air-alias-scopes(kernel_exp10_hits_the_round_powers)"}
!28 = !{!29}
