...
; ModuleID = 'tr.bc'
source_filename = "validation/fixtures/public/kernel_fast_trig_range.metal"
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v28-apple-macosx26.0.0"

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite)
define void @kernel_fast_trig_range(ptr addrspace(1) noundef writeonly captures(none) "air-buffer-no-alias" %0, ptr addrspace(1) noundef readonly captures(none) "air-buffer-no-alias" %1) local_unnamed_addr #0 {
  ...
  %20 = tail call fast <3 x float> @air.fast_sin.v3f32(<3 x float> %10) #2
  %21 = tail call fast <3 x float> @air.fast_cos.v3f32(<3 x float> %19) #2
  ...
  %24 = tail call fast float @air.fast_sin.f32(float %23) #2
  %25 = getelementptr inbounds float, ptr addrspace(1) %1, i64 7
  %26 = load float, ptr addrspace(1) %25, align 4, !tbaa !21, !alias.scope !25, !noalias !28
  %27 = tail call fast float @air.fast_cos.f32(float %26) #2
  %28 = extractelement <3 x float> %20, i64 0
  store float %28, ptr addrspace(1) %0, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %29 = extractelement <3 x float> %20, i64 1
  %30 = getelementptr inbounds float, ptr addrspace(1) %0, i64 1
  store float %29, ptr addrspace(1) %30, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %31 = extractelement <3 x float> %20, i64 2
  %32 = getelementptr inbounds float, ptr addrspace(1) %0, i64 2
  store float %31, ptr addrspace(1) %32, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %33 = extractelement <3 x float> %21, i64 0
  %34 = getelementptr inbounds float, ptr addrspace(1) %0, i64 3
  store float %33, ptr addrspace(1) %34, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %35 = extractelement <3 x float> %21, i64 1
  %36 = getelementptr inbounds float, ptr addrspace(1) %0, i64 4
  store float %35, ptr addrspace(1) %36, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %37 = extractelement <3 x float> %21, i64 2
  %38 = getelementptr inbounds float, ptr addrspace(1) %0, i64 5
  store float %37, ptr addrspace(1) %38, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %39 = getelementptr inbounds float, ptr addrspace(1) %0, i64 6
  store float %24, ptr addrspace(1) %39, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %40 = getelementptr inbounds float, ptr addrspace(1) %0, i64 7
  store float %27, ptr addrspace(1) %40, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  ret void
}
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none)
declare <3 x float> @air.fast_cos.v3f32(<3 x float>) local_unnamed_addr #1
...
!9 = !{ptr @kernel_fast_trig_range, !10, !11}
!10 = !{}
!11 = !{!12, !13}
...
!20 = !{!"/Users/aneesiqbal/Projects/steelbrain/metal2vulkan/validation/fixtures/public/kernel_fast_trig_range.metal"}
!21 = !{!22, !22, i64 0}
!22 = !{!"float", !23, i64 0}
...
!27 = distinct !{!27, !"air-alias-scopes(kernel_fast_trig_range)"}
!28 = !{!29}
