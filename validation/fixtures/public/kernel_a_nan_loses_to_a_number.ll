...
; `-fno-fast-math` is what makes the frontend emit the PLAIN `air.fmax.f32`, `air.fmin.f32`,
; `air.clamp.f32` and `air.saturate.f32` instead of their `air.fast_*` siblings; the plain symbols
; are the ones whose NaN contract this fixture exists to pin.
; Not derived from a third-party metallib.
; ModuleID = 'kernel_a_nan_loses_to_a_number.bc'
source_filename = "validation/fixtures/public/kernel_a_nan_loses_to_a_number.metal"
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v28-apple-macosx26.0.0"

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite)
define void @kernel_a_nan_loses_to_a_number(ptr addrspace(1) noundef readonly captures(none) "air-buffer-no-alias" %0, ptr addrspace(1) noundef writeonly captures(none) "air-buffer-no-alias" %1) local_unnamed_addr #0 {
  ...
  %16 = tail call float @air.fmax.f32(float %3, float %7) #2
  store float %16, ptr addrspace(1) %1, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %17 = tail call float @air.fmax.f32(float %7, float %3) #2
  %18 = getelementptr inbounds float, ptr addrspace(1) %1, i64 1
  store float %17, ptr addrspace(1) %18, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %19 = tail call float @air.fmin.f32(float %3, float %7) #2
  %20 = getelementptr inbounds float, ptr addrspace(1) %1, i64 2
  store float %19, ptr addrspace(1) %20, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %21 = tail call float @air.fmin.f32(float %7, float %3) #2
  %22 = getelementptr inbounds float, ptr addrspace(1) %1, i64 3
  store float %21, ptr addrspace(1) %22, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %23 = tail call float @air.clamp.f32(float %3, float %9, float %11) #2
  %24 = getelementptr inbounds float, ptr addrspace(1) %1, i64 4
  store float %23, ptr addrspace(1) %24, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %25 = tail call float @air.clamp.f32(float %5, float %9, float %11) #2
  %26 = getelementptr inbounds float, ptr addrspace(1) %1, i64 5
  store float %25, ptr addrspace(1) %26, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %27 = tail call float @air.saturate.f32(float %3) #2
  %28 = getelementptr inbounds float, ptr addrspace(1) %1, i64 6
  store float %27, ptr addrspace(1) %28, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %29 = tail call float @air.fmax.f32(float %3, float %5) #2
  ...
  %35 = tail call float @air.clamp.f32(float %13, float %9, float %11) #2
  %36 = getelementptr inbounds float, ptr addrspace(1) %1, i64 8
  store float %35, ptr addrspace(1) %36, align 4, !tbaa !21, !alias.scope !28, !noalias !25
  %37 = tail call float @air.clamp.f32(float %15, float %9, float %11) #2
  %38 = getelementptr inbounds float, ptr addrspace(1) %1, i64 9
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none)
declare float @air.saturate.f32(float) local_unnamed_addr #1
...
!9 = !{ptr @kernel_a_nan_loses_to_a_number, !10, !11}
!10 = !{}
!11 = !{!12, !13}
...
!20 = !{!"/private/tmp/nancase/kernel_a_nan_loses_to_a_number.metal"}
!21 = !{!22, !22, i64 0}
!22 = !{!"float", !23, i64 0}
...
!27 = distinct !{!27, !"air-alias-scopes(kernel_a_nan_loses_to_a_number)"}
!28 = !{!29}
