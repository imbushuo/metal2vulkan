...
define void @agx_emask_edge_lanes(ptr addrspace(1) readonly captures(none) "air-buffer-no-alias" %0, ptr addrspace(1) captures(none) "air-buffer-no-alias" %1, ptr addrspace(2) readonly align 4 captures(none) dereferenceable(4) "air-buffer-no-alias" %2, i32 %3) local_unnamed_addr #0 {
  ...
  %pa = getelementptr inbounds i32, ptr addrspace(1) %0, i64 %idxa64
  %va = tail call <4 x i32> @llvm.agx3.load.with.emask.global.v4i32(ptr addrspace(1) %pa, i16 zeroext %mask, i16 zeroext 15, i16 zeroext 4)
  %qa = getelementptr inbounds i32, ptr addrspace(1) %1, i64 %idxa64
  tail call void @llvm.agx3.store.with.emask.global.v4i32(ptr addrspace(1) %qa, <4 x i32> %va, i16 zeroext 15, i16 zeroext 15, i16 zeroext 4)
  %idxb = add i32 %idxa, 32
  %idxb64 = zext i32 %idxb to i64
  %pb = getelementptr inbounds i32, ptr addrspace(1) %0, i64 %idxb64
  %vb = tail call <4 x i32> @llvm.agx3.load.with.emask.global.v4i32(ptr addrspace(1) %pb, i16 zeroext 15, i16 zeroext 15, i16 zeroext 4)
  %qb = getelementptr inbounds i32, ptr addrspace(1) %1, i64 %idxb64
  tail call void @llvm.agx3.store.with.emask.global.v4i32(ptr addrspace(1) %qb, <4 x i32> %vb, i16 zeroext %mask, i16 zeroext 15, i16 zeroext 4)
  ret void
}
...
; Unknown intrinsic
declare <4 x i32> @llvm.agx3.load.with.emask.global.v4i32(ptr addrspace(1), i16, i16, i16)

; Unknown intrinsic
declare void @llvm.agx3.store.with.emask.global.v4i32(ptr addrspace(1), <4 x i32>, i16, i16, i16)
...
!9 = !{ptr @agx_emask_edge_lanes, !10, !11}
!10 = !{}
!11 = !{!12, !13, !14, !15}
